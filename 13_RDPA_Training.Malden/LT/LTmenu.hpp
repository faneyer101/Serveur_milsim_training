	...
	class Controls
	{
		class MainMenu : LT_RscControlsGroup
		{
			...
			class Controls
			{
				...
				{
					idc = -1;
					text = "Selectionne un joueur pour lui transferer l'équipement";
					x = 0.25;
					y = 0.2;
					w = 0.5;
					h = (1 / 25);
	...
	class Controls
	{
		class MainMenu : LT_RscControlsGroup
		{
			...
			class Controls
			{
				...
				{
					idc = -1;
					text = "Selectionne l'équipement à transferer";
					x = 0.25;
					y = 0.2;
					w = 0.5;
					h = (1 / 25);
	...
	class Controls
	{
		class MainMenu : LT_RscControlsGroup
		{
			...
			class Controls
			{
				...
				{
					idc = -1;
					text = "Selectionne l'équipement à charger";
					x = 0.25;
					y = 0.2;
					w = 0.5;
					h = (1 / 25);
	...
	class Controls
	{
		class MainMenu : LT_RscControlsGroup
		{
			...
			class Controls
			{
				...
				{
					idc = -1;
					text = "Sélectionnez un joueur pour charger son chargement";
					x = 0.25;
					y = 0.2;
					w = 0.5;
					h = (1 / 25);
...
class LT_MainMenu
{
	...
	class controlsBackground {
		class LT_RscTitleBackground :LT_RscText {
			colorBackground[] = { "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])" };
			idc = -1;
			text = "Menu de transfert de chargement";
			x = 0.3;
			y = 0.2;
			w = 0.47;
			h = (1 / 25);

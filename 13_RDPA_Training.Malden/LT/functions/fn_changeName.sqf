...
if (_newName != _originalName) then
{
	...
	if (_overwrite != -1) then
	{
		...
		((findDisplay 2550) displayCtrl 2551) ctrlSetStructuredText parseText format["<t align='center'><t size='.8px'>Voulez-vous vraiment remplacer l'équipement:</t></t><br/><t align='center'><t size='0.6px'>%1</t></t>", _newName];
